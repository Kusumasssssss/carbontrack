...
public interface ActivityLogRepository extends JpaRepository<ActivityLog, Long> {
    ...
    @Query("SELECT COUNT(DISTINCT a.date) FROM ActivityLog a WHERE a.user = :user AND a.date >= :startDate")
    Long countActiveDays(@Param("user") User user, @Param("startDate") LocalDate startDate);
