...
const Login = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-bg-dark px-4 py-10">
      <div className="relative w-full max-w-3xl min-h-[560px] bg-slate-900/80 border border-slate-800 rounded-3xl shadow-2xl shadow-black/40 overflow-hidden">
        ...
        >
          <form onSubmit={handleSignIn} className="w-full px-8 sm:px-12 flex flex-col items-center text-center">
            ...
            <p className="text-sm text-slate-400 mb-6">Sign in to your Avni workspace</p>
            ...
            <button type="button" className="text-xs text-brand-400 hover:text-brand-300 my-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 uppercase tracking-wider text-xs font-bold bg-brand-500 hover:bg-brand-400 text-slate-950 rounded-full px-10 py-3.5 shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-colors disabled:opacity-60"
            >
            ...
            <div className="w-full mt-6 flex items-center gap-3">
              ...
              <span className="text-[11px] text-slate-500">Enterprise SSO</span>
              <div className="flex-1 border-t border-slate-800" />
            </div>
            ...
            <div className="w-full grid grid-cols-2 gap-3 mt-4">
              <a
                ...
                className="flex items-center justify-center gap-2 bg-slate-800/70 hover:bg-slate-800 text-slate-300 text-xs font-medium py-2.5 rounded-lg border border-slate-700 transition-all"
              >
            ...
            <button
              ...
              className="md:hidden mt-6 text-sm text-brand-400 underline"
            >
              New to Avni? Create an account
            </button>
          </form>
        </div>
        ...
        >
          <form onSubmit={handleSignUp} className="w-full px-8 sm:px-12 flex flex-col items-center text-center">
            ...
            <p className="text-sm text-slate-400 mb-6">Set up Avni for your organization</p>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 uppercase tracking-wider text-xs font-bold bg-brand-500 hover:bg-brand-400 text-slate-950 rounded-full px-10 py-3.5 mt-6 shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-colors disabled:opacity-60"
            >
        ...
        >
          <div className="relative h-full w-full bg-gradient-to-br from-brand-600 via-brand-500 to-emerald-700 text-slate-950 overflow-hidden">
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-slate-950/10 flex items-center justify-center mb-4">
                <Leaf size={26} />
              </div>
              ...
              <button
                onClick={() => setIsSignUp(true)}
                className="border-2 border-slate-950 rounded-full uppercase text-xs font-bold tracking-wider px-10 py-3 hover:bg-slate-950 hover:text-brand-400 transition-colors"
              >
                Sign Up
              </button>
            </div>
