    ...
    <div className="flex items-center justify-center min-h-screen w-full px-4">
      <div className="glass-panel w-full max-w-[400px] p-8 animate-fade-in">
        ...
        <a 
          ...
          className="w-full mt-6 flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white font-medium py-3 px-6 rounded-xl border border-white/10 transition-all transform hover:-translate-y-[1px]"
        >
        ...
        <a 
          ...
          className="w-full mt-3 flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white font-medium py-3 px-6 rounded-xl border border-white/10 transition-all transform hover:-translate-y-[1px]"
        >
