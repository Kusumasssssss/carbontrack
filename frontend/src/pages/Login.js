...
const Login = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="flex items-center justify-center w-full px-4 text-slate-50">
      <div className="bg-slate-800/60 backdrop-blur-xl w-full max-w-[420px] p-10 rounded-3xl shadow-2xl shadow-emerald-900/20 border border-slate-700/50 relative overflow-hidden">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm font-medium text-slate-400">
            Don't have an account? <Link to="/signup" className="text-emerald-400 hover:text-emerald-300 font-semibold transition-colors">Sign up for free</Link>
          </p>
        </div>
      </div>
    </div>
