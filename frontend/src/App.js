...
const NotFound = () => (
  <div className="flex flex-col items-center justify-center min-h-[50vh] bg-surface-card rounded-2xl p-8 text-center border-2 border-dashed border-surface-border">
